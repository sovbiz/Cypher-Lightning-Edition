<template>
    <div class="isolate bg-colorBgLight dark:bg-colorBgDark px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div class="mx-auto max-w-2xl text-center">
        <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl dark:text-white ">Point of sale</h2>
        <p class="mt-2 text-lg leading-8 text-gray-600 dark:text-white ">Create an invoice or change the address to send sats back</p>
      </div>
