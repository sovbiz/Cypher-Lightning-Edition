<template>
  ...
  <div
    style="z-index: 99"
    class="h-full w-full fixed bg-colorBgLight dark:bg-colorBgDark overflow-scroll isolate px-6 pt-14 lg:px-8 bg-[url('/stock/nogood/NG_Cypher_Header_Light.png')] dark:bg-[url('/stock/nogood/NG_Cypher_Header_Dark.png')] bg-hero bg-no-repeat md:bg-cover bg-center bg-fixed"
  >
    <img
    ...
    <div class="max-w-4xl mx-auto mt-6">
      <div class="space-y-12">
        <div class="border-b border-gray-900/10 pb-12 text-center">
          ...
          <div
            class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 mx-auto"
          >
            ...
            <div class="sm:col-span-6 mx-auto">
              <label
                ...
                >{{ t("bitcoinaddress") }}
                <a
                  href="https://cypher.space/docs/setup#bitcoin-wallet"
                  class="underline"
                  target="_blank"
                  >📖 {{ t("readmore") }}</a
                ></label
            ...
            <div class="sm:col-span-6 mx-auto">
              <label
                ...
                >{{ t("pubkey") }}
                <a
                  href="https://cypher.space/docs/setup#nostr"
                  class="underline"
                  target="_blank"
                  >📖 {{ t("readmore") }}</a
                ></label
              ...
              <div class="mt-6 space-y-6">
                <div class="relative flex gap-x-3">
                  ...
                  <div class="text-sm leading-6">
                    <label
                      class="font-medium text-gray-900 dark:text-white inline"
                      >{{ t("publish") }}
                    </label>
            ...
            <div class="sm:col-span-6 mx-auto">
              <label
                ...
                >{{ t("lnaddress") }}
                <a
                  href="https://cypher.space/docs/setup#lightning-address"
                  class="underline"
                  target="_blank"
                  >📖 {{ t("readmore") }}</a
                ></label
            ...
            <div class="sm:col-span-6 mx-auto">
              <label
                ...
                >{{ t("webhook") }}
                <a
                  href="https://cypher.space/docs/setup#webhook"
                  class="underline"
                  target="_blank"
                  >📖 {{ t("readmore") }}</a
                ></label
