...
<section aria-labelledby="shipping-heading" class="mt-10">
          ...
          <div class="mt-6 grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-4">
            ...
            <div class="sm:col-span-2">
              <label for="firstname" class="block text-sm font-medium text-gray-700 dark:text-white">{{ t('FirstName') }}</label>
              <div class="mt-1">
                <input type="text" v-model="firstname" id="firstname" name="firstname" autocomplete="firstname" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm dark:text-black">
              </div>
            </div>

            <div class="sm:col-span-2">
              <label for="lastname" class="block text-sm font-medium text-gray-700 dark:text-white">{{ t('LastName') }}</label>
              <div class="mt-1">
                <input type="text" v-model="lastname" id="lastname" name="lastname" autocomplete="lastname" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm dark:text-black">
              </div>
            </div>

            <div class="sm:col-span-2">
              <label for="company" class="block text-sm font-medium text-gray-700 dark:text-white">{{ t('Company') }}</label>
              <div class="mt-1">
                <input type="text" v-model="company" id="company" name="company" autocomplete="comapany" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm dark:text-black">
              </div>
            </div>
            ...
            <div class="sm:col-span-4">
              <label for="address" class="block text-sm font-medium text-gray-700 dark:text-white">{{ t('Address') }}</label>
              <div class="mt-1">
                <input type="text" v-model="address" id="address" name="address" autocomplete="street-address" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm dark:text-black">
              </div>
            </div>

            <div class="sm:col-span-4">
              <label for="apartment" class="block text-sm font-medium text-gray-700 dark:text-white">{{ t('Addition') }}</label>
              <div class="mt-1">
                <input type="text" v-model="apartment" id="apartment" name="apartment" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm dark:text-black">
              </div>
            </div>

            <div class="sm:col-span-2">
              <label for="city" class="block text-sm font-medium text-gray-700 dark:text-white">{{ t('City') }}</label>
              <div class="mt-1">
                <input type="text" v-model="city" id="city" name="city" autocomplete="address-level2" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm dark:text-black">
              </div>
            </div>

            <div class="sm:col-span-2">
              <label for="postal-code" class="block text-sm font-medium text-gray-700 dark:text-white">{{ t('Postcode') }}</label>
              <div class="mt-1">
                <input type="text" v-model="postalcode" id="postal-code" name="postal-code" autocomplete="postal-code" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm dark:text-black">
              </div>
            </div>

            <div class="sm:col-span-2">
              <label for="region" class="block text-sm font-medium text-gray-700 dark:text-white">{{ t('StateProvince') }}</label>
              <div class="mt-1">
                <input type="text" v-model="region" id="region" name="region" autocomplete="address-level1" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm dark:text-black">
              </div>
            </div>
            ...
            <div class="sm:col-span-2">
              <label for="country" class="block text-sm font-medium text-gray-700 dark:text-white">{{ t('Country') }}</label>
              <div class="mt-1">
                <input type="text" v-model="country" id="country" name="country" autocomplete="country" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm dark:text-black">
              </div>
            </div>
          ...
          <div>
            ...
            <dd class="mt-2 text-gray-700 dark:text-white">
              <address class="not-italic">
                ...
                <span class="block"> {{ firstname }} {{ lastname }}</span>
                <span class="block">{{ company }} {{ email }} </span>
                <span class="block">{{ address }} {{ apartment }}</span>
                <span class="block">{{ postalcode }} {{ city }}, {{ country }} {{region}}</span>
              </address>
            </dd>
          </div>
          <div>
...
<div class=" px-4 pb-24 pt-16 sm:px-6 sm:pt-24 lg:px-8 lg:py-16 rounded-3xl border-4 border-gray-600 mt-4" v-if="launchStep == 'payment' || displaymode == true">
