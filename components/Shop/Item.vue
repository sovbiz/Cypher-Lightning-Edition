<template>
  <div class="bg-colorBgLight dark:bg-colorBgDark">
    ...
    <div class="rounded-md bg-yellow-50 p-4 max-w-3xl mx-auto border-2 border-black dark:border-white" v-if="variationwarning == true" >
    <div class="flex">
      ...
      <div class="flex md:gap-x-6 flex-col md:flex-row">
        ...
        <!-- Product info -->
        <div
          class="mt-2 px-4  sm:px-0 lg:mt-0 w-3/4 inline text-left mx-auto"
        >
          <p
          ...
          <div class="mt-6" v-if="product.variations != ''">
                ...
                <RadioGroup v-model="selectedVariation" class="mt-2">
                  ...
                  <div class="grid grid-cols-3 gap-3 sm:grid-cols-6">
                    <RadioGroupOption as="template" v-for="size in product.variations" :key="size" :value="size" v-slot="{ active, checked }">
