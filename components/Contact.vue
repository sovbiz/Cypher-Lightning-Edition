<template>
    <div class="isolate  px-6 py-24 sm:py-24 lg:px-8">
      ...
      <div class="mx-auto max-w-2xl text-center">
        <h2 class="text-3xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-4xl">{{ t("title") }}</h2>
        <p class="mt-2 text-lg leading-8 text-gray-600 dark:text-white">{{ t("subtitle") }}</p>
      </div>


      <div class="max-w-xl mt-12 rounded-md bg-yellow-50 p-4 max-w-3xl mx-auto border-2 border-black dark:border-white" v-if="warning == 'error'">
    <div class="flex">
  ...
  <div class="max-w-xl mt-12 rounded-md bg-green-50 p-4 max-w-3xl mx-auto border-2 border-black dark:border-white" v-if="warning == 'success'">
    <div class="flex">
      <div class="flex-shrink-0">
        <PaperAirplaneIcon class="h-5 w-5 text-green-400" aria-hidden="true" />
      </div>
      <div class="ml-3">
      ...
      <div class="mx-auto mt-16 max-w-xl sm:mt-20">
        <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
          <div>
            <label for="first-name" class="block text-sm font-semibold leading-6 text-gray-900 dark:text-white">{{ t("firstname") }}</label>
            <div class="mt-2.5">
              <input type="text" name="first-name" v-model="firstname" autocomplete="given-name" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
            </div>
          </div>
          <div>
            <label for="last-name" class="block text-sm font-semibold leading-6 text-gray-900 dark:text-white">{{ t("lastname") }}</label>
            <div class="mt-2.5">
              <input type="text" name="last-name" v-model="lastname" autocomplete="family-name" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
            </div>
          </div>
          <div class="sm:col-span-2">
            <label for="company" class="block text-sm font-semibold leading-6 text-gray-900 dark:text-white">{{ t("company") }}</label>
            <div class="mt-2.5">
              <input type="text" name="company" v-model="company" autocomplete="organization" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
            </div>
          </div>
          <div class="sm:col-span-2">
            <label for="email" class="block text-sm font-semibold leading-6 text-gray-900 dark:text-white">{{ t("email") }}</label>
            <div class="mt-2.5">
              <input type="email" name="email" v-model="email" autocomplete="email" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
            </div>
          </div>
          <div class="sm:col-span-2">
            <label for="npub" class="block text-sm font-semibold leading-6 text-gray-900 dark:text-white">{{ t("npub") }}</label>
            <div class="mt-2.5">
              <input type="text" name="npub" v-model="npub" autocomplete="npub" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
            </div>
          </div>
          <div class="sm:col-span-2">
            <label for="message" class="block text-sm font-semibold leading-6 text-gray-900 dark:text-white">{{ t("message") }}</label>
            <div class="mt-2.5">
              <textarea name="message" v-model="message" rows="4" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
            </div>
          </div>
          ...
          :to="localePath('/tos')"
              ...
              class="font-semibold text-black dark:text-white underline">{{ t("termsOfService") }}</NuxtLink>.
            </SwitchLabel>
          </SwitchGroup>
        </div>
        <div class="mt-10">
          <button @click="sendForm()" class="block w-full rounded-md bg-indigo-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">{{ t("letsTalk") }}</button>
        </div>
      </div>
    </div>
  </template>
  ...
  import { ExclamationTriangleIcon, PaperAirplaneIcon } from '@heroicons/vue/20/solid'
